...
var $author$project$Main$Model = function (passage) {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'NoOp') {
			...
			var new_code = msg.a;
			return $author$project$Main$Model(new_code);
		}
	});
...
var $author$project$Components$Code$autocode = function (str) {
	return A2(
		$elm$html$Html$pre,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$view = function (model) {
	var _v0 = A2($elm$core$Debug$log, model.passage, '');
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('p-4 bg-slate-100 h-screen')
			]),
		_List_fromArray(
			[
				A2(
